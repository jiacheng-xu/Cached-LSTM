...
def init_params(options):
    ...
    params = param_init_rnn(options, params, prefix='rnn', in_dim=options['wdim'], out_dim=options['edim'])
...
def build_model(tparams, options):
    ...
    proj = rnn(tparams, emb, options, mask=mask, prefix='rnn', in_dim=options['wdim'],

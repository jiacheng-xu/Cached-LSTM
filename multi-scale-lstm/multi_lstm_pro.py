...
def init_params(options):
    ...
    params = param_init_multi_lstm_s(options, params, prefix='multi_lstm_pro', in_dim=options['wdim'], out_dim=options['edim'])
...
def build_model(tparams, options):
    ...
    proj = multi_lstm_pro(tparams, emb, options, mask=mask, prefix='multi_lstm_pro', in_dim=options['wdim'],
                out_dim=options['edim'])
    rt = proj

...
def init_params(options):
    ...
    # params = param_init_gru_conv(options, params, prefix='gru_conv_32', nin=options['dim_hidden'], dim=options['dim_hidden'])
...
def build_model(tparams, options):
    ...
    proj = emb
    proj_11 = gru_conv_naive(tparams, proj, options, prefix='gru_conv_11', mask=mask[:-1], out_dim=options['dim_hidden'])
    # proj_12 = gru_conv_naive(tparams, proj[1:-1], options, prefix='gru_conv_12', mask=mask[1:-1], out_dim=options['dim_hidden'])

...
def init_params(options):
    ...
    params = param_init_gru_conv(options, params, prefix='gru_conv', nin=options['dim_hidden'], dim=options['dim_hidden'])
...
def build_model(tparams, options):
    ...
    proj = gru_conv(tparams, proj, options, prefix='gru_conv', mask=mask,
                     out_dim=options['dim_hidden'])
